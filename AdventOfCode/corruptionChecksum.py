...
testchecksum = """493	458	321	120	49	432	433	92	54	452	41	461	388	409	263	58
...
testchecksum = testchecksum.splitlines()
newChecksum = []
for row in testchecksum:
    newChecksum.append(row.split("\t"))

def scoreDiffCalc(checksum):
    """This function takes in a list like
    [[num1,num2,num3],[num4,num5,num6]]
    and in each sublist i.e [num1,num2,num3]
    finds the largest and smallest number,
    and adds their difference to score.
    
    Remember that num1,num2,etc are numbers in string form !!!h"""
    ...
    for line in checksum:
        ...
        for i in line:
            ...
            if int(i) < lowest:
                lowest = int(i)
        score += (largest - lowest)
    return score

print(scoreDiffCalc(newChecksum))


def scoreDivCalc(checksum):
    """This function takes in a list like
    [[num1,num2,num3],[num4,num5,num6]]
    and in each sublist i.e [num1,num2,num3]
    finds a number which divides another number perfectly
    and adds the result of their division to score.
    
    Remember that num1,num2,etc are numbers in string form !!!"""
...
print(scoreDivCalc(newChecksum))
